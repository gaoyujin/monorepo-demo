<template>
  <div>
    ...
    <el-row class="mb-4">
      ...
      <SpButton type="danger">Danger</SpButton>
    </el-row>

    <div>
      <SpTableSearch
        :model="refData.searchForm"
        :searchItems="refData.itemsConfig"
...
import { SpButton, SpTableSearch } from '@sp/pc-ui'
import { UiType } from '@sp/pc-ui/src/tableSearch/src/types'
